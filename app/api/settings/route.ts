...
export async function PUT(req: Request) {
  try {
    ...
    console.log("Received payload:", data); // Log the received payload
    ...
    if (data.preferences.monthlyBudget !== undefined && isNaN(data.preferences.monthlyBudget)) {
      return NextResponse.json({ error: 'Invalid monthly budget value' }, { status: 400 });
    }
