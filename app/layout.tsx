...
export const metadata: Metadata = {
  title: "FineGuide - Personal Finance Management",
  description:
    "Master your money with FineGuide's AI-powered finance tools. Smart budgeting, expense tracking, and AI-assisted financial planning with LLM integration to help you achieve your financial goals.",
  keywords:
  ...
  openGraph: {
    title: "FinGuide - Personal Finance Management",
    description: "Master your money with FineGuide's AI-powered finance tools",
    type: "website",
    locale: "en_US",
