...
export default function ExpensesPage() {
  ...
  const defaultCategories = [
    ...
    { name: "Savings", icon: <PiggyBank className="w-4 h-4" /> },
    ...
    <div className="relative">
      <div className="min-h-screen w-full bg-background text-foreground dark:bg-gray-950 dark:text-gray-100">
        ...
        <label className="block text-sm font-medium text-gray-700">
          Select Savings Percentage
        </label>
        <select
          className="w-full mt-1 p-2 border border-gray-300 rounded-md focus:ring focus:ring-green-200"
        >
